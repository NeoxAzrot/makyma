namespace :makyma do
  ...
  task import: :environment do
...

    {
        ...
        cuisine: ['Cuisine', 'bowl.png', 'Change le monde à ton échelle en remplaçant les objets de ton quotidien par des alternatives vertes et durables ! On te sert des solutions sur un plateau, c’est du tout cuit 🍽️'],
